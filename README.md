...
- A way to better orgainze and manipulate your code, especially in regards to repition and size of the code

2. What is your favorite concept in preprocessing? What is the concept that gives you the most trouble?

- I like how well mixins can work and how they can make changing one feature of a problem so easy

3. How would you explain the concept of a variable to someone new to programming?

- A  variable is something that stores information/data that can be used for a variety of purposes

4. What is the purpose of using functions in code?

- It makes it so you can reuse code when you are looking for specific results 

5. What is a JSON data?

- (JavaScript Object Notation) is a format that is easy for us to read but also computable by the computer
that can be used to transfer data
